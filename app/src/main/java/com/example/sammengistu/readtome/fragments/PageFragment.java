...
import com.example.sammengistu.readtome.dialogs.ChaptersDialog;
import com.example.sammengistu.readtome.dialogs.DefinitionDialog;
import com.example.sammengistu.readtome.dialogs.HelpDialog;
import com.example.sammengistu.readtome.dialogs.SelectPageDialog;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_select_chapter:
                ...
                chaptersDialog.setTargetFragment(PageFragment.this,
                    GET_CHAPTER_NUMBER);
